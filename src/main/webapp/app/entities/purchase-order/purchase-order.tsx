...
export const PurchaseOrder = (props: IPurchaseOrderProps) => {
  ...
  const { purchaseOrderList, match, loading, totalItems } = props;
  return (
    <div>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('supplierId')}>
                  Supplier Id <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('shippingDate')}>
                  Shipping Date <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('shippingRequired')}>
                  Shipping Required <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {purchaseOrder.shippingDate ? (
                      <TextFormat type="date" value={purchaseOrder.shippingDate} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{purchaseOrder.shippingRequired ? 'true' : 'false'}</td>
                  <td>
                    {purchaseOrder.createdDate ? (
                      <TextFormat type="date" value={purchaseOrder.createdDate} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${purchaseOrder.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      >
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${purchaseOrder.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
                      >
