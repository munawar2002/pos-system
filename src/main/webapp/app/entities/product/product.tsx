          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('buyPrice')}>
                  Buy Price <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('sellPrice')}>
                  Sell Price <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {productList.map((product, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {product.createdDate ? <TextFormat type="date" value={product.createdDate} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
