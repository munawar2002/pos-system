  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="posSystemApp.productCategory.home.createOrEditLabel">Create or edit a ProductCategory</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : productCategoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="createdByLabel" for="product-category-createdBy">
                  Created By
                </Label>
                <AvField id="product-category-createdBy" type="text" name="createdBy" />
              </AvGroup>
              <AvGroup>
                <Label id="creationDateLabel" for="product-category-creationDate">
                  Creation Date
                </Label>
                <AvInput
                  id="product-category-creationDate"
                  type="datetime-local"
                  className="form-control"
                  name="creationDate"
                  placeholder={'YYYY-MM-DD HH:mm'}
                  value={isNew ? displayDefaultDateTime() : convertDateTimeFromServer(props.productCategoryEntity.creationDate)}
                  validate={{
                    required: { value: true, errorMessage: 'This field is required.' },
                  }}
                />
