...
public class EmployeeResourceIT {
    ...
    private static final Designation DEFAULT_DESIGNATION = Designation.SALES_ASSOCIATE;
    private static final Designation UPDATED_DESIGNATION = Designation.CASHIER;
    ...
    public void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getJhiUserId()).isEqualTo(DEFAULT_JHI_USER_ID);
    ...
    @Test
    @Transactional
    public void checkJhiUserIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = employeeRepository.findAll().size();
        // set the field null
        employee.setJhiUserId(null);
    ...
    public void updateEmployee() throws Exception {
        ...
        assertThat(testEmployee.getJhiUserId()).isEqualTo(UPDATED_JHI_USER_ID);
